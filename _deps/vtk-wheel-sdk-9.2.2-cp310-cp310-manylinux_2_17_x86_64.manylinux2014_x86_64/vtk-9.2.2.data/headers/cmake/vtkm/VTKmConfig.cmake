...
set(VTKm_VERSION_FULL "1.8.0")
set(VTKm_VERSION "1.8")
...
if(CMAKE_CURRENT_LIST_DIR STREQUAL "/builds/gitlab-kitware-sciviz-ci/build/vtk-9.2.2.data/headers/cmake/vtkm")
  set(VTKm_PACKAGE_IN_BUILD TRUE)
endif()

if(VTKm_PACKAGE_IN_BUILD)
  set_and_check(VTKm_CMAKE_MODULE_PATH "/builds/gitlab-kitware-sciviz-ci/ThirdParty/vtkm/vtkvtkm/vtk-m/CMake")
else()
  set_and_check(VTKm_CMAKE_MODULE_PATH "${PACKAGE_PREFIX_DIR}/vtk-9.2.2.data/headers/cmake/vtkm/cmake")
endif()
...
set_and_check(VTKm_CONFIG_DIR "${PACKAGE_PREFIX_DIR}/vtk-9.2.2.data/headers/cmake/vtkm")
set(VTKM_FROM_INSTALL_DIR FALSE)
if(NOT "${CMAKE_BINARY_DIR}" STREQUAL "/builds/gitlab-kitware-sciviz-ci/build/ThirdParty/vtkm/vtkvtkm/vtk-m")
