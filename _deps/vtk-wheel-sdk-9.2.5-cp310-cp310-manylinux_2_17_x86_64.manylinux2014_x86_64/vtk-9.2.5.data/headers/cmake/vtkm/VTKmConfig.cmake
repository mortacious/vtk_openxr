...
if(CMAKE_CURRENT_LIST_DIR STREQUAL "/builds/gitlab-kitware-sciviz-ci/build/vtk-9.2.5.data/headers/cmake/vtkm")
...
if(VTKm_PACKAGE_IN_BUILD)
  ...
  set_and_check(VTKm_CMAKE_MODULE_PATH "${PACKAGE_PREFIX_DIR}/vtk-9.2.5.data/headers/cmake/vtkm/cmake")
endif()
...
set_and_check(VTKm_CONFIG_DIR "${PACKAGE_PREFIX_DIR}/vtk-9.2.5.data/headers/cmake/vtkm")
